...
export const damageUser = (
  ...
  if (instant || residual) {
    consequences.set(effect.id, {
      ...
      types: types,
      ...(instant ? (effect.type === "pierce" ? { pierce_damage: damage, damage: damage } : { damage: damage }) : {}),
      ...(residual ? (effect.type === "pierce" ? { residual_pierce: damage, residual: damage } : { residual: damage }) : {}),
    });
  }
