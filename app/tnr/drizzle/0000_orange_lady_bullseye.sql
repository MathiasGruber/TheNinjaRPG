...
CREATE TABLE `UserData` (
	...
	`curHealth` int NOT NULL DEFAULT 100,
	`maxHealth` int NOT NULL DEFAULT 100,
	`curChakra` int NOT NULL DEFAULT 100,
	`maxChakra` int NOT NULL DEFAULT 100,
	`curStamina` int NOT NULL DEFAULT 100,
	...
	`eloPve` int NOT NULL DEFAULT 1,
	`eloPvp` int NOT NULL DEFAULT 1,
