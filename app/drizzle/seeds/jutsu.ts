...
const jutsus: ZodJutsuType[] = [
  ...
  {
    name: "Poisonous Bite",
    image: "/jutsus/poison_bite.png",
    description:
      "Used by beasts, striking their prey with a venomous bite that seeps through their veins, leaving them poisoned.",
    battleDescription: "%user uses its poisonous bite on %target",
    jutsuType: "AI" as const,
    jutsuRank: "D" as const,
    requiredRank: "STUDENT" as const,
    target: "OTHER_USER" as const,
  ...
  {
    name: "Poisonous Spit",
    image: "/jutsus/poisonous_spit.png",
    description:
      "Used by beasts, spewing venomous saliva that engulfs its adversaries, inflicting excruciating pain and debilitating effects.",
    battleDescription: "%user spews its poisonous spit on %target",
    jutsuType: "AI" as const,
    jutsuRank: "D" as const,
    requiredRank: "STUDENT" as const,
    target: "OTHER_USER" as const,
