...
CREATE TABLE `Item` (
	...
	`slot` enum('HEAD','CHEST','LEGS','FEET','HAND','ITEM','NONE') NOT NULL,
...
CREATE TABLE `UserItem` (
	...
	`equipped` enum('HEAD','CHEST','LEGS','FEET','HAND_1','HAND_2','ITEM_1','ITEM_2','ITEM_3','ITEM_4','ITEM_5','ITEM_6','ITEM_7','NONE') NOT NULL DEFAULT 'NONE');
