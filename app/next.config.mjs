...
const ContentSecurityPolicy = `
  default-src 'self';
  script-src 'self' 'unsafe-eval' 'unsafe-inline' *.google-analytics.com *.googletagmanager.com *.doubleclick.net *.clerk.accounts.dev *.vercel.live  *.paypal.com *.tiny.cloud *.theninja-rpg.com *.opendns.com *.highlight.io https://plausible.io;
  child-src 'self' *.doubleclick.net *.paypal.com ghbtns.com *.youtube.com;
